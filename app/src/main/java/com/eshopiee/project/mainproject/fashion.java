...
public class fashion extends AppCompatActivity implements LocationListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        faRef = FirebaseDatabase.getInstance().getReference().child("Location").child("Fashion");
        faRef.keepSynced(true);

        fur_recview = (RecyclerView) findViewById(R.id.Fash_Rec);
    ...
    protected void onStart() {
        ...
        faRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Radapter = new fashion_store_adapter(fashion.this,list);
