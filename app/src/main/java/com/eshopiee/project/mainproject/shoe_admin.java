...
public class shoe_admin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoe_admin);

        mDatabase = FirebaseDatabase.getInstance().getReference().child("Location").child("Shoe");
        ...
        shwbtn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                startActivity(new Intent(shoe_admin.this, shoe_data.class));
            }
        });
    ...
    private void saveUserInformation(){
        ...
        String key = database.getReference("Location").child("Shoe").push().getKey();
