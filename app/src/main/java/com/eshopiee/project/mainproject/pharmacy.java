...
public class pharmacy extends AppCompatActivity implements LocationListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pRef = FirebaseDatabase.getInstance().getReference().child("Location").child("Pharmacy");
        pRef.keepSynced(true);

        fur_recview = (RecyclerView) findViewById(R.id.Pha_Rec);
        ...
        databaseReference = database.getReference("Location").child("Pharmacy");
        list = new ArrayList<>();
    ...
    protected void onStart() {
        ...
        pRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Radapter = new pharmacy_store_adapter(pharmacy.this,list);
