...
public class Res_Admin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_res__admin);

        mDatabase = FirebaseDatabase.getInstance().getReference().child("Location").child("Restaurant");
        ...
        shwbtn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                startActivity(new Intent(Res_Admin.this, Restaurant_data.class));
            }
        });
    ...
    private void saveUserInformation(){
        ...
        String key = database.getReference("Location").child("Restaurant").push().getKey();
