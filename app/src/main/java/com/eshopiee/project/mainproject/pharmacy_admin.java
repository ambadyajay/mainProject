...
public class pharmacy_admin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_med__admin);

        mDatabase = FirebaseDatabase.getInstance().getReference().child("Location").child("Pharmacy");
        ...
        shwbtn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                startActivity(new Intent(pharmacy_admin.this, pharmacy_data.class));
            }
        });
    ...
    private void saveUserInformation(){
        ...
        String key = database.getReference("Location").child("Pharmacy").push().getKey();
