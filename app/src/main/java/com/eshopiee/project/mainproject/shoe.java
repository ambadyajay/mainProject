...
public class shoe extends AppCompatActivity implements LocationListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sRef = FirebaseDatabase.getInstance().getReference().child("Location").child("Shoe");
        ...
        databaseReference = database.getReference("Location").child("Shoe");
        list = new ArrayList<>();
    ...
    protected void onStart() {
        ...
        sRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Radapter = new Shoe_store_adapter(shoe.this,list);
