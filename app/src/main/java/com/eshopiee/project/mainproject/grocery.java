...
public class grocery extends AppCompatActivity implements LocationListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gRef = FirebaseDatabase.getInstance().getReference().child("Location").child("Grocery");
        gRef.keepSynced(true);

        fur_recview = (RecyclerView) findViewById(R.id.Gro_Rec);
        ...
        databaseReference = database.getReference("Location").child("Grocery");
        list = new ArrayList<>();
    ...
    protected void onStart() {
        ...
        gRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Radapter = new Grocery_store_adapter(grocery.this,list);
                fur_recview.setLayoutManager(layoutManager);
                fur_recview.setAdapter(Radapter);
            }
