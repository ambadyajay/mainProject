...
public class fashion_admin extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fashion_admin);

        mDatabase = FirebaseDatabase.getInstance().getReference().child("Location").child("Fashion");
        ...
        shwbtn.setOnClickListener(new View.OnClickListener(){
            public void onClick(View v) {
                startActivity(new Intent(fashion_admin.this,fashion_data.class));
            }
        });
    ...
    private void saveUserInformation(){
        ...
        String key = database.getReference("Location").child("Fashion").push().getKey();
